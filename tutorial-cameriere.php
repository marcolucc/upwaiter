    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          ...
          <ol>  
            <li><a href="#Rispondere a un annuncio"><font size="5">Rispondere a un annuncio</font></a></li>
            ...
            <li><a href="#Gestire le candidature"><font size="5">Eliminare il profilo</font></a></li>
          ...
          <h3></h3>
            ...
            <h4>Rispondere a un annuncio</h4>
            <p style="text-align:left">Puoi rispondere ad un annuncio dalla sezione "Annunci", che trovi in alto nel menù</p>
            </section>
            ...
            <p style="text-align:left">L'opzione stipendio espressa in Euro/Ora è un dato che i ristoratori possonon includere nel testo dell'annuncio in manierafacoltativa, quindi quando non visualizzi, in alcuni annunci, lo stipendio significa che il ristoratore vuole discutere di questo aspetto privatamente in sede di colloquio.</p>
            </section>
