    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          ...
          <ol>  
            <li><a href="#Creare un annuncio"><font size="5">Creați un anunț</font></a></li>
            <li><a href="#Modificare il profilo"><font size="5">Modificați anunțul</font></a></li>
            <li><a href="#Come funziona l'opzione Stipendio"><font size="5">Cum funcționează secțiunea Salariu</font></a></li>
            <li><a href="#Gestire le candidature"><font size="5">Gestionarea candidațiilor</font></a></li>
          ...
          <h3></h3>
            ...
            <h4>Creați un anunț</h4>
            <p style="text-align:left">Pentru a crea un anunț intrați in Dashboard-ul dvs. și urmați pașii necesari.</p>
            </section>
            
            <section id="Modificare il profilo">
            <h4>Modificați anunțul</h4>
            <p style="text-align:left">Pentru a vă modifica profilul accesați DashBoard-ul și urmați procedura ilustrată.</p>
            </section>
            
            <section id="Come funziona l'opzione Stipendio">
            <h4>Cum funcționează secțiunea Salariu</h4>
            <p style="text-align:left">Secțiunea Salariu exprimată în Euro/Oră este o infromație pe care restaurantele o pot introduce în anunț.</p>
            </section>
            
            <section id="Gestire le candidature">
            <h4>Gestionarea candidațiilor</h4>
